...
## This is a custom setup for my own keyboard

Created a newkeyboard called nmsplit. Everything else is equal to MB R2G CRKBD

Default keymap is default.

There is a small image on righ oled.

The left oled has been rotated vertically, and shows Default, One (numbers), Two (special chars) and
ADJ (for 'settings').

```
Compile - qmk compile -kb nmsplit/r2g -km default
```
